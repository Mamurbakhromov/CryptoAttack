import type { ApiStatus, DashboardSnapshot, ExchangeKey, ExchangeSymbolsQuery, ExchangeSymbolsRefreshResult, ExchangeSymbolsResponse, NormalizedEvent, ScoreDetailResponse, ScoreEvidenceResponse, ScoreListQuery, ScoreMarketRegimeResponse, ScoreSnapshotSseEvent, ScoreTimelineResponse, ScoreUpdateSseEvent, ScoresListResponse, ScoringConfigCurrentResponse, SpotPerformanceResponse, StorageStatusResponse, StreamState } from '../types';
